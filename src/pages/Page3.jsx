    ...
    <>
        <div id='homePage' className="bg-[rgb(1,32,105)] w-full relative text-white">
            ...
            <div className="grid grid-cols-8 grid-rows-20 gap-2 max-sm:gap-7 overflow-x-hidden">
                <div className="elem rounded-xl overflow-hidden w-[300px] max-sm:w-[100px] h-fit max-sm:h-[100px] max-sm:gap-5 col-span-1 row-span-1" style={{"--r": 1, "--c": 1}}><img className="w-full h-full object-contain max-sm:object-cover max-sm:object-left" src="/assets/Project-images/DUO-SS.png" alt="" /></div>
